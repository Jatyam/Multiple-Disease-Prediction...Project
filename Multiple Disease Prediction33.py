...
def add_animated_background():
    """
    Adds a full-window background image with a gentle color shift (via hue-rotation).
    Replace the URL below with your preferred image, or switch to a local file
    and encode it as base64 if desired.
    """
    st.markdown(
        """
        <style>
        /* Keyframe for continuous hue rotation */
        ...
        /* Apply the background image and animation to the main app container */
        .stApp {
            background: url("https://images.unsplash.com/photo-1571494146904-1d7c16f9f6b5");
            background-size: cover;
            background-repeat: no-repeat;
            background-attachment: fixed;
            
            /* The animation line below continuously rotates the hue
               over 30 seconds (adjust to your liking). */
...
# ------------------------------------------------------------------------------
# 3) Apply animated background before rendering anything else
# ------------------------------------------------------------------------------
...
# ------------------------------------------------------------------------------
# 6) Simple theme toggle approach
#    (Be aware that your custom background might clash with a theme background.)
# ------------------------------------------------------------------------------
ms = st.session_state
if "themes" not in ms:
    ms.themes = {
